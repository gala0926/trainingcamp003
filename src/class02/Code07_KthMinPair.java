...
例如arr = {3, 1, 2}，数值对有(3,3), (3,1), (3,2），（1,3）,(1,1), (1,2),(2,3),(2,1），（2,2），也就是任意两个数都有数值对，而且自己和自己也算数值对。数值对如何排序？
规定：第一维数据从小到大，第一维数据一样的，第二维数据也从小到大。所以上面的数值对排序结果为：(1,1)(1,2)（1,3）(2,1）（2,2）(2,3)(3,1)(3,2）(3,3)
给定一个arr和正数k，返回第k小的数值对
**/
package class02;
